...
<link href="../public_html/css/styles.css" rel="stylesheet" type="text/css" media="screen" />
<link href="../public_html/css/print.css" rel="stylesheet" type="text/css" media="print" />
<script type="text/javascript" src="../public_html/js/nav.js"></script>
</head>
<body>
  <div id="container">
    <div id="header" >
...
if ($ok eq "ok") {
  ...
  foreach my $prodotto (@prodotti) {
        ...
        foreach my $property ($prodotto) {
             ...
             print "<img class=\"immagine_p\" src=\"../public_html/images/prodotti/", encode_entities($img_prodotto), "\" alt=\"$alt\" />";
